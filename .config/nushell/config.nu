...
$env.config = {
    ...
    datetime_format: {
        normal: '%a, %d %b %z'    # shows up in displays of variables or other datetime's outside of tables
        table: '%m/%d/%y %I:%M %p'          # generally shows up in tabular outputs such as ls. commenting this out will change it to the default human readable datetime format
    }
